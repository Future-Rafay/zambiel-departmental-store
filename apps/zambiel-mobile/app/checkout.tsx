...
export default function CheckoutScreen() {
  ...
  return <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ padding: space.md, gap: space.md }}>
    ...
    <View accessibilityRole="radiogroup" style={{ flexDirection: "row", gap: 8 }}><Choice value="DELIVERY" current={fulfillment} set={setFulfillment} label={locale === "de" ? "Lieferung" : "Delivery"}/><Choice value="PICKUP" current={fulfillment} set={setFulfillment} label={locale === "de" ? "Abholung" : "Pickup"}/></View>
