...
const config: ExpoConfig = {
  ...
  plugins: ["expo-router", "expo-secure-store", "expo-font", "expo-localization", "expo-web-browser", ["expo-notifications", { color: "#153B35" }], "@react-native-google-signin/google-signin"],
